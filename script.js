...
function(){
    if(document.visibilityState === "visible"){
        document.title = "Portfolio | Priyank Gupta";
        $("#favicon").attr("href","favicon.ico");
    }
    else {
        document.title = "Come Back To Portfolio";
        $("#favicon").attr("href","favihand.ico");
    }
});
...
// <!-- typed js effect starts -->
    var typed = new Typed(".typing-text", {
        strings: ["Web Development", "Data structure and Algorithm", "Competitive Programming", "Freelancing"],
        loop: true,
        typeSpeed: 50,
		backSpeed: 25,
		backDelay: 500,
